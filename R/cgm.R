...
l1<-"---"
l2<-paste0("title: \'", day, "-", year," ", data[2,2],"\'")
l3<-paste0("date: \'", year, "-", day, "\'")
l4<-paste0('archive: [\"', year, '\", ', '\"', year, "-", month, '\", ', '\"', year, "-", day, '\"]')
l5<-"categories:"
l6<-"  - 学术报告"
...
l22 <-"# 关键词"
l23<-data[4,2]
ll<-rbind(l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,blank,l11,l12,l13,l14,blank, l15,l16,l17, blank, l18,l19, blank, l20,l21, blank, l22,l23)
datex<- paste0(year, "-", day)
